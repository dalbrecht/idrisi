"""Service for importing macOS Photos albums into Idrisi projects."""
...
from idrisi.domain.value_objects import Coordinates, MapType

if TYPE_CHECKING:
    from uuid import UUID

    from idrisi.application.interfaces import GeocodingService, PhotosLibraryPort
    ...
    from idrisi.domain.value_objects import AlbumSummary, PhotoCluster
...
class AlbumService:
    """Orchestrates importing a Photos album into a Idrisi project."""
    ...
    def import_album(
        ...
        """Import an album as a Idrisi project.
