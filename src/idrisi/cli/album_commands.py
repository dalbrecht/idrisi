...
def get_album_dependencies() -> AlbumService:
    ...
    from idrisi.infrastructure.photos.osxphotos_adapter import OsxPhotosAdapter  # noqa: PLC0415
...
def _print_result(result: AlbumImportResult, *, dry_run: bool = False) -> None:
    ...
    if not dry_run:
        ...
        console.print()
        console.print(f'Done. Render with: idrisi render "{result.project_name}"')
    else:
        console.print()
