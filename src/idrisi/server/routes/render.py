...
from idrisi.domain.errors import BadRequestError, ProjectNotFoundError
...
def _get_dependencies(request: Request) -> tuple[Any, ...]:
    ...
    from idrisi.infrastructure.db.repository import (  # noqa: PLC0415
        SqlPlaceRepository,
        SqlProjectRepository,
        SqlRegionRepository,
        SqlTripRepository,
    )
    from idrisi.infrastructure.renderer.engine import RenderEngine  # noqa: PLC0415
    from idrisi.infrastructure.renderer.styles import load_style  # noqa: PLC0415
...
def create_render_router() -> APIRouter:
    ...
    def render_project(request: Request, project_id: str) -> FileResponse:
        from idrisi.domain.value_objects import MapType, OutputFormat  # noqa: PLC0415
