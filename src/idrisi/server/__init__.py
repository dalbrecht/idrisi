"""FastAPI application factory for the Idrisi server."""
...
from idrisi.domain.errors import BadRequestError, EntityNotFoundError
from idrisi.infrastructure.db.models import Base
from idrisi.infrastructure.db.session import get_session
from idrisi.server.routes.places import create_places_router
from idrisi.server.routes.projects import create_projects_router
from idrisi.server.routes.regions import create_regions_router
from idrisi.server.routes.render import create_render_router
from idrisi.server.routes.trips import create_trips_router
...
def create_app(database_url: str = "sqlite:///idrisi.db") -> FastAPI:
