...
.PHONY: help bootstrap dev test lint lint-fix fmt build serve build-web run ls sync-standards ci clean repo-setup pr
...
repo-setup: ## Initialize git hooks and submodules
