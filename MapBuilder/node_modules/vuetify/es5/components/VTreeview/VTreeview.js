...
require('../../../src/stylus/components/_treeview.styl');
    ...
    mounted: function mounted() {
        ...
        if (this.openAll) {
            Object.keys(this.nodes).forEach(function (key) {
                return _this3.updateOpen((0, _helpers.getObjectValueByPath)(_this3.nodes[key].item, _this3.itemKey), true);
            });
        } else {
    ...
    methods: {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                var node = {
                    ...
                    children: children.map(function (c) {
                        return (0, _helpers.getObjectValueByPath)(c, _this4.itemKey);
                    }),
                    item: item
                };
        ...
        handleNodeCacheWatcher: function handleNodeCacheWatcher(value, cache, updateFn, emitFn) {
            ...
            value = this.returnObject ? value.map(function (v) {
                return (0, _helpers.getObjectValueByPath)(v, _this6.itemKey);
            }) : value;
        ...
        updateSelected: function updateSelected(key, isSelected) {
            ...
            parents.forEach(function (parent) {
                ...
                changed.set(parent, _this8.nodes[parent].isSelected);
            });
